<div class="mx-auto max-w-7xl flex flex-col items-center my-5">
    <div class="z-10 bg-gray-900/70 rounded-3xl max-w-5xl py-6 w-11/12 px-4">
        <div class="mx-auto max-w-2xl lg:mx-0 z-20 mb-4">
            <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl text-center underline">About Us</h2>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <a class="ml-2 underline" aria-label="Get directions to this location on Google Maps."
