...
<div class="relative w-full max-w-lg mx-auto overflow-hidden">
    ...
    <div class="carousel">
        ...
        <div class="w-full flex-shrink-0">
            <x-google.review-card>
                <x-slot name="review">
                    The Smoke House is a great place to get your fix whether it's Nicotine or THC. The new owner is very
                    knowledgeable and kind and was able to help with any doubts I had. The prices were fair and their
        ...
        <div class="w-full flex-shrink-0">
            <x-google.review-card>
                <x-slot name="review">
                    Best place for all your tobacco, vapes and accessories! Owner & staff are so helpful! Go check them
                    out!
                </x-slot>
                <x-slot name="url">
