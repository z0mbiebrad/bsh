<div class="">
    <div class="relative isolate overflow-hidden">
        <img src="{{ asset('images/storefront.jpg') }}" alt=""
            class="absolute inset-0 -z-10 h-full w-full object-cover object-left">
        <div class="absolute inset-0 bg-teal-950 opacity-85 -z-10"></div>
        ...
        <div class="mx-auto max-w-5xl sm:w-11/12 py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
                ...
                <p class="mt-6 md:text-2xl leading-8 font-bold text-white px-4 mb-32">Welcome to Biscoe Smoke House, your
                    one-stop shop for
